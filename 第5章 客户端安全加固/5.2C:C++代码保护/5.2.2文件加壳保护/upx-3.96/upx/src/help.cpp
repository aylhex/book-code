...
#define V(x)    (strcmp(UPX_VERSION_STRING, UPX_VERSION_STRING4) ? UPX_VERSION_STRING : UPX_VERSION_STRING x)
    ...
    con_fprintf(f,
                "                       UPX modified by AYL\n"
                "     Modified based on UPX 3.96 and used only for program testing\n"
                "The real authors of UPX are Markus Oberhumer, Laszlo Molnar & John Reiser Jan\n\n");
// #if defined(UPX_VERSION_GITREV)
//                 gitrev,
//                 (sizeof(gitrev)-1 > 6 && gitrev[sizeof(gitrev)-2] == '+') ? '+' : ' ',
// #elif (ACC_OS_DOS16 || ACC_OS_DOS32)
//                 V("d"),
// #endif (ACC_OS_WIN16 || ACC_OS_WIN32 || ACC_OS_WIN64)
//                 V("w"),
// #else
//                 UPX_VERSION_STRING,
// #endif
